...
export const Date: React.FC = () => {
    ...
    //получение массива возможных дат для записи к доктору
    ...
    //отрисовка возможных дат для записи в виде слайдов
    const days = data.map((d, i) => (
        <IonSlide key={d.day}>
            <Day
                day={d.day}
                date={d.date}
                active={selectedDay === i ? true : false}
            />
        </IonSlide>
    ))
    ...
    return (
        <div className={s.wrapper}>
            <div className={s.top}>
                <p className={s.top_title}>Возможная дата</p>
                <div className={s.top_controls}>
                    <button className={s.controls_button}>
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
